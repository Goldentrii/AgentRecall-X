  ...
  switch (command) {
    ...
    case "digest": {
      ...
      if (sub === "store") {
        ...
        // fix5 (2026-09-11): resolve before the write — markStale rewrites
        // the digest index via writeJsonAtomic (ensureDir on the parent), so
        // the raw literal "auto" here could materialize projects/auto/digest.
        core.markStale(await core.resolveProject(project ?? "auto"), id, reason, hasFlag("--global", digRest));
